...
if __name__ == '__main__':
    ...
    opt = utils.parse_arg()
    assert opt.beta in [10, 2.5, 1, 0.1,None],'Beta only tested with the following: [10 (Nearly Random splitting),2.5(Mild Heterogeneity),1(Moderate Heterogeneity),0.1(Severe Heterogeneity),None], None results in a random split'
